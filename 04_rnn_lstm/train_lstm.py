...
for step in range(n_steps):
    ...
    ys, h_prev, c_prev = lstm.forward(inputs, h_prev, c_prev)
    loss = lstm.backward(targets, ys, lr=learning_rate)
    ...
    if step % 500 == 0 or step == n_steps - 1:
        ...
        sample_h, sample_c = h_prev.copy(), c_prev.copy()
        sample_x = inputs[0]
        generated = ""
        for _ in range(80):
            sample_ys, sample_h, sample_c = lstm.forward([sample_x], sample_h, sample_c)
